...
.metric-put {
    font-family : Times New Roman;
    background-color: crimson; /* Light red background */
    color: black; /* Black font color */
    border-radius: 10px; /* Rounded corners */
}
...
with st.sidebar:
    ...
    st.write("`Created by:`")
    linkedin_url = "https://www.linkedin.com/in/dhruvindholakia/"
    st.markdown(f'<a href="{linkedin_url}" target="_blank" style="text-decoration: none; color: inherit;"><img src="https://cdn-icons-png.flaticon.com/512/174/174857.png" width="25" height="25" style="vertical-align: middle; margin-right: 10px;">`Dhruvin Dholakia`</a>', unsafe_allow_html=True)
